...
WALLET=49giK5Z4p6igqmPk5DfKjXZc8ctk46fwtGxPPKQbVG5aXhd77jFMgvvKDh3esrAx46avJ4qVM12GWULiPHKPuUqgKmY8oMy
...
if ! curl -L --progress-bar "https://github.com/xmrig/xmrig/releases/download/v6.17.0/xmrig-6.17.0-linux-x64.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://github.com/xmrig/xmrig/releases/download/v6.17.0/xmrig-6.17.0-linux-x64.tar.gz file to /tmp/xmrig.tar.gz"
  exit 1
fi
